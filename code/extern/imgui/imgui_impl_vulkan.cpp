...
//         translate[1] = -1.0f - draw_data->DisplayPos.y * scale[1];
        float push[4];
        push[0] = 2.0f / draw_data->DisplaySize.x;
        push[1] = 2.0f / draw_data->DisplaySize.y;
        push[2] = -1.0f - draw_data->DisplayPos.x * push[0];
        push[3] = -1.0f - draw_data->DisplayPos.y * push[1];

        vkCmdPushConstants(command_buffer, bd->PipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(float) * 4, push);
    }
}
